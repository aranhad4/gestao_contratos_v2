...
class Contrato(models.Model):
    ...
    observacao_rateio = models.TextField(max_length=250, null=True, blank=True)
    ...
    observacao_reajuste = models.CharField(max_length=100, null=True, blank=True)
...
class HistoricoContrato(models.Model):
    ...
    campos_alterados = models.JSONField(blank=True, default=dict)  # Campos alterados
