...
class ContratoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['nome_fornecedor', 'responsavel', 'categoria', 'c_contabil', 'observacao_contrato',
                  ...
                  'indice_reajuste', 'observacao_reajuste', 'data_reajuste', 'status', 'contrato_file', 'imagem', 'observacao_distrato', 'flag_distrato', 'anexo_distrato', 'flag_rateio', 'cnpj_fornecedor',]
